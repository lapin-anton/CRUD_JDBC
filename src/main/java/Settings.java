...
public class Settings {
    ...
    public Settings() throws Exception {
        ...
        if(f.exists()) {
            ...
            isNotExists = true;
            ConsoleHelper.writeMessage("Файл с настройками подключения к БД и серверу приложения отсутствует.\n" +
                    "После внесения настроек снова запустите сервер приложения.");
        }
    }
